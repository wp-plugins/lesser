 ...
 */
class LesserAdminPageFramework_Property_Page extends LesserAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aLesserAdminPageFramework']['aPageClasses'] = isset($GLOBALS['aLesserAdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aLesserAdminPageFramework']['aPageClasses']) ? $GLOBALS['aLesserAdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aLesserAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
