 ...
 */
abstract class LesserAdminPageFramework_Form_Model extends LesserAdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new LesserAdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
