 ...
 */
abstract class LesserAdminPageFramework_Page_View_MetaBox extends LesserAdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aLesserAdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aLesserAdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aLesserAdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aLesserAdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aLesserAdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aLesserAdminPageFramework']['bAddedMetaBoxScript'] = true;
