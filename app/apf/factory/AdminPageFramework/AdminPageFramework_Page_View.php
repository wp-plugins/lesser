 ...
 */
abstract class LesserAdminPageFramework_Page_View extends LesserAdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new LesserAdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
