 ...
 */
abstract class LesserAdminPageFramework_Form_Model_Export extends LesserAdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new LesserAdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
