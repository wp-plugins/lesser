 ...
 */
abstract class LesserAdminPageFramework_Form_Model_Import extends LesserAdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new LesserAdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
