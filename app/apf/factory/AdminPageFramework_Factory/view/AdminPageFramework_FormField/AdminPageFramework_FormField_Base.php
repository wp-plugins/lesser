 ...
 */
abstract class LesserAdminPageFramework_FormField_Base extends LesserAdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new LesserAdminPageFramework_Script_Widget;
        ...
        new LesserAdminPageFramework_Script_Utility;
        new LesserAdminPageFramework_Script_OptionStorage;
        new LesserAdminPageFramework_Script_AttributeUpdator;
        new LesserAdminPageFramework_Script_RepeatableField($this->oMsg);
        new LesserAdminPageFramework_Script_Sortable;
        new LesserAdminPageFramework_Script_RegisterCallback;
    }
