 ...
 */
class LesserAdminPageFramework_FormTable_Base extends LesserAdminPageFramework_FormOutput {
    public function __construct($aFieldTypeDefinitions, array $aFieldErrors, $oMsg = null) {
        ...
        $this->oMsg = $oMsg ? $oMsg : LesserAdminPageFramework_Message::getInstance();
        $this->_loadScripts();
    }
    ...
    private function _loadScripts() {
        ...
        new LesserAdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new LesserAdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new LesserAdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . LesserAdminPageFramework_Registry::NAME . ' ' . LesserAdminPageFramework_Registry::getVersion() . "</div>";
    }
}