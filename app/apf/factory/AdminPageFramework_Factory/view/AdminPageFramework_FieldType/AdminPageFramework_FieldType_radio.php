 ...
 */
class LesserAdminPageFramework_FieldType_radio extends LesserAdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new LesserAdminPageFramework_Input_radio($aField['attributes']);
