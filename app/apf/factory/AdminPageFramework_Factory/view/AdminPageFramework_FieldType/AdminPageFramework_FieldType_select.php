 ...
 */
class LesserAdminPageFramework_FieldType_select extends LesserAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new LesserAdminPageFramework_Input_select($aField['attributes']);
