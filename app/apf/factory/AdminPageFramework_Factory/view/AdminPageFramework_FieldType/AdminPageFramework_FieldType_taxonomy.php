 ...
 */
class LesserAdminPageFramework_FieldType_taxonomy extends LesserAdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new LesserAdminPageFramework_Script_CheckboxSelector;
    }
