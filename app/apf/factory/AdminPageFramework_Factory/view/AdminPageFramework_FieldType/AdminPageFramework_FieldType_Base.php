 ...
 */
abstract class LesserAdminPageFramework_FieldType_Base extends LesserAdminPageFramework_WPUtility {
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new LesserAdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
