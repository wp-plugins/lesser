 ...
 */
class LesserAdminPageFramework_FieldType_size extends LesserAdminPageFramework_FieldType_select {
...
CSSRULES;
    ...
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
        ...
        $_oUnitInput = new LesserAdminPageFramework_Input_select($_aUnitAttributes + array('select' => $_aUnitAttributes));
