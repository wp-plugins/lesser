 ...
 */
class LesserAdminPageFramework_FieldType_system extends LesserAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new LesserAdminPageFramework_ErrorReporting;
