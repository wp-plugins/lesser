 ...
 */
class LesserAdminPageFramework_FieldType_checkbox extends LesserAdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new LesserAdminPageFramework_Input_checkbox($aField['attributes']);
