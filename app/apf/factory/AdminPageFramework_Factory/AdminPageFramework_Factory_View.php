 ...
 */
abstract class LesserAdminPageFramework_Factory_View extends LesserAdminPageFramework_Factory_Model {
    ...
    private function _getFormFieldElementCallbacks() {
        return array('hfID' => array($this, '_replyToGetInputID'), 'hfTagID' => array($this, '_replyToGetInputTagIDAttribute'), 'hfName' => array($this, '_replyToGetInputNameAttribute'), 'hfNameFlat' => array($this, '_replyToGetFlatInputName'), 'hfClass' => array($this, '_replyToGetInputClassAttribute'),) + $this->oProp->aFieldCallbacks;
    }
    ...
    private function _getSettingNotice(array $aNotice) {
        ...
        $aNotice['aAttributes']['class'] = $this->oUtil->generateClassAttribute($this->oUtil->getElement($aNotice, array('aAttributes', 'class'), ''), 'admin-page-framework-settings-notice-container');
