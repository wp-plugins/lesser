 ...
 */
abstract class LesserAdminPageFramework_Resource_Base {
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->oUtil->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), LesserAdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->oUtil->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), LesserAdminPageFramework_CSS::getDefaultCSSIE());
