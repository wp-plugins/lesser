 ...
 */
abstract class LesserAdminPageFramework_Link_Base extends LesserAdminPageFramework_WPUtility {
    ...
    private function _getFooterInfoRight($aScriptInfo) {
        ...
        return "<span class='apf-credit'>" . $this->oMsg->get('powered_by') . '&nbsp;' . $_sLibraryInfo . ",&nbsp;" . $this->generateHTMLTag('a', array('href' => 'https://wordpress.org', 'target' => '_blank', 'title' => 'WordPress' . $GLOBALS['wp_version']), 'WordPress') . "</span>";
    }
