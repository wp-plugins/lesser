 ...
 */
class LesserAdminPageFramework_WPUtility_URL extends LesserAdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(LesserAdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(LesserAdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = LesserAdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
