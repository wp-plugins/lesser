 ...
 */
abstract class LesserAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['aLesserAdminPageFramework'] = isset($GLOBALS['aLesserAdminPageFramework']) && is_array($GLOBALS['aLesserAdminPageFramework']) ? $GLOBALS['aLesserAdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => LesserAdminPageFramework_Registry::NAME, 'sURI' => LesserAdminPageFramework_Registry::URI, 'sScriptName' => LesserAdminPageFramework_Registry::NAME, 'sLibraryName' => LesserAdminPageFramework_Registry::NAME, 'sLibraryURI' => LesserAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => LesserAdminPageFramework_Registry::getVersion(), 'sDescription' => LesserAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => LesserAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => LesserAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => LesserAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => LesserAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
